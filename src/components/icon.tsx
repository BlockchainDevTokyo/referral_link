const InfoMark = (width: any, height: any) => {
  return (
    <svg
...
const Arrow = ({ width, height, color, direction, className }: ArrowProps) => {
  let rotate = '';
  if (direction === 'down') rotate = 'rotate-180';
  if (direction === 'right') rotate = 'rotate-90';
  if (direction === 'left') rotate = '-rotate-90';
  return (
    <svg
